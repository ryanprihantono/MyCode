...
{
    public partial class MasterServices : Form
    {
        ...
        public MasterServices()
        {
            ...
            this.query = "select productCode,product,price,prodCat from TIWProduct"
                        ...
                        + " where (TIWProductCategory.prodCatId=1 or TIWProductCategory.prodCatId=2) and locationGroupId=" + Session.locations[0].locationGroupId;
        ...
        {
            AddEditServices svc = new AddEditServices();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                AddEditServices svc = new AddEditServices(productCode);
                if (!isWindowExists(svc))
                {
                    svc.MdiParent = this.MdiParent;
                    svc.Disposed += new EventHandler(svc_Disposed);
