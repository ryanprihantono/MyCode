...
{
    public partial class MasterOthers : Form
    {
        ...
        public MasterOthers()
        {
            ...
            this.query = "select productCode,product,price,prodCat from TIWProduct"
                        ...
                        + " where TIWProductCategory.prodCatId=4 and locationGroupId=" + Session.locations[0].locationGroupId;
        ...
        {
            AddEditOthers svc = new AddEditOthers();
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                AddEditOthers svc = new AddEditOthers(productCode);
                if (!isWindowExists(svc))
                {
                    svc.MdiParent = this.MdiParent;
                    svc.Disposed += new EventHandler(svc_Disposed);
