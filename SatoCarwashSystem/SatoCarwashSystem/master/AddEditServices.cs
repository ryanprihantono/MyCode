...
{
    public partial class AddEditServices : Form
    {
        int productId;
        bool isEdit=false;
        public AddEditServices()
        {
            InitializeComponent();
            this.Text = "Add Sevices";
        }
        public AddEditServices(String productCode)
        {
            InitializeComponent();
            ...
            txtPrice.Text = temp + ""; 
            cmbCategory.Text = result.getString("prodCat");
            dc.disconnect();
            isEdit = true;
        ...
        private void submit()
        {
            if (txtProduct.Text == "" || txtPrice.Text == "" || cmbCategory.SelectedIndex == -1)
            {
